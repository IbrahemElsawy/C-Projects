...
#define _CRT_SECURE_NO_WARNINGS // To make sure that it will not display any warnings when testing it on matrix.
...
{                  // This is to start the body of the program.
    ...
    double cash; // The double float variable for this program.
    float balanceOwing; // The float variable for this program.
    

    printf ("Please enter the amount to be paid: $"); // This is to ask the user to enter the amount of money that needs to be paid.
    scanf ("%lf", &cash); // This program stores the data that the user has put.


    loonies = (int)cash;   // This converts the cash variable on the right side into an integer for the integer variable, "loonies" on the left side.
    ...
    printf ("Quarters required: %d, ", quarters); // This tells the user how many quarters are required to pay the remaining amount.
